...
public static class HelperFunctions 
{
    ...
    {
        return Physics.Raycast(_transform.position + new Vector3(0, 1, 0), _transform.forward, _distance);
    }
    public static bool CheckAheadForColi(Transform _transform, float _distance, string _layerName)
    {
        return Physics.Raycast(_transform.position + new Vector3(0, 1, 0), _transform.forward, _distance, LayerMask.GetMask(_layerName));
    }
